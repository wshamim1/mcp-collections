...
See [PRACTICAL_FAQ.md](PRACTICAL_FAQ.md) for common questions about company-hosted MCP servers, client usage, and production security.

---

## Production Checklist (Quick)

- [ ] Define explicit tools (avoid unrestricted "run anything" endpoints)
- [ ] Enforce input schemas and validation
- [ ] Implement role/tenant access controls
- [ ] Add request IDs and audit logging
- [ ] Add retries, timeouts, and circuit breakers for external calls
- [ ] Add health checks and alerts
- [ ] Test with `mcp dev` inspector before release
